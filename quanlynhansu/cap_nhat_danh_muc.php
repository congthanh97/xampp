...
$RCDanhmuc_DS = mysqli_query( $Myconnection,$query_RCDanhmuc_DS) or die(mysql_error( $Myconnection));
...
<table width="800" border="0" cellspacing="1" cellpadding="0" align="center">
  <tr>
	...
	//mysql_select_db($database_Myconnection, $Myconnection);
		...
		$RCDanhmuc_CN = mysqli_query($Myconnection,$query_RCDanhmuc_CN) or die(mysql_error( $Myconnection));
