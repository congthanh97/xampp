...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $Result1 = mysqli_query($updateSQL) or die(mysql_error($Myconnection));
...
$RCcapnhat_congviec = mysqli_query($Myconnection,$query_RCcapnhat_congviec) or die(mysql_error($Myconnection));
...
$RCphongban1 = mysqli_query($Myconnection,$query_RCphongban1) or die(mysql_error($Myconnection));
...
$RCphongban = mysqli_query($Myconnection,$query_RCphongban) or die(mysql_error($Myconnection));
...
$RCctcongviec1 = mysqli_query($Myconnection,$query_RCctcongviec1) or die(mysql_error($Myconnection));
...
$RCctcongviec = mysqli_query($Myconnection,$query_RCctcongviec) or die(mysql_error($Myconnection));
...
$RCChucvu1 = mysqli_query($Myconnection,$query_RCChucvu1) or die(mysql_error($Myconnection));
...
$RCChucvu = mysqli_query($Myconnection,$query_RCChucvu) or die(mysql_error($Myconnection));
...
$RCHocvan1 = mysqli_query($Myconnection,$query_RCHocvan1) or die(mysql_error($Myconnection));
...
$RCHocvan = mysqli_query($Myconnection,$query_RCHocvan) or die(mysql_error($Myconnection));
...
$RCBangcap1 = mysqli_query($Myconnection,$query_RCBangcap1) or die(mysql_error($Myconnection));
...
$RCBangcap = mysqli_query($Myconnection,$query_RCBangcap) or die(mysql_error($Myconnection));
...
$RCNgoaingu1 = mysqli_query($Myconnection,$query_RCNgoaingu1) or die(mysql_error($Myconnection));
...
$RCNgoaingu = mysqli_query($Myconnection,$query_RCNgoaingu) or die(mysql_error($Myconnection));
...
$RCTinhoc1 = mysqli_query($Myconnection,$query_RCTinhoc1) or die(mysql_error($Myconnection));
...
$RCTinhoc = mysqli_query($Myconnection,$query_RCTinhoc) or die(mysql_error($Myconnection));
...
$RCDantoc1 = mysqli_query($Myconnection,$query_RCDantoc1) or die(mysql_error($Myconnection));
...
$RCDantoc = mysqli_query($Myconnection,$query_RCDantoc) or die(mysql_error($Myconnection));
...
$RCQuoctich1 = mysqli_query($Myconnection,$query_RCQuoctich1) or die(mysql_error($Myconnection));
...
$RCQuoctich = mysqli_query($Myconnection,$query_RCQuoctich) or die(mysql_error($Myconnection));
...
$RCTongiao1 = mysqli_query($Myconnection,$query_RCTongiao1) or die(mysql_error($Myconnection));
...
$RCTongiao = mysqli_query($Myconnection,$query_RCTongiao) or die(mysql_error($Myconnection));
...
$RCTinhthanh1 = mysqli_query($Myconnection,$query_RCTinhthanh1) or die(mysql_error($Myconnection));
...
$RCTinhthanh = mysqli_query($Myconnection,$query_RCTinhthanh) or die(mysql_error($Myconnection));
